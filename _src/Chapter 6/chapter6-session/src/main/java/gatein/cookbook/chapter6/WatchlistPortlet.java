...
public class WatchlistPortlet extends GenericPortlet {
    ...
    public void displayWatchList(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        String watchStock = (String)request.getPortletSession().getAttribute("watchStock", PortletSession.APPLICATION_SCOPE);
        request.getPortletSession().removeAttribute("watchStock", PortletSession.APPLICATION_SCOPE);
